...
#print_three_trees([do_QBT(graph_1, IMSIZE), do_QBT(graph_2, IMSIZE), do_QBT(graph_W, IMSIZE)], figsize=(10, 5))
...
print_three_trees([server.subtree_1, server.subtree_2], figsize=(10, 5))
